...
public interface SVGItemMovieLast {

    public static final double WIDTH = 51.531;

    public static final double HEIGHT = 51.531;

    public static final String CONTENT =
            "M44.9,1.963c-3.662,0-6.631,2.969-6.631,6.631V23.81c-0.285-0.324-0.617-0.609-1-0.831L6,4.926"
