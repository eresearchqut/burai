...
public interface SVGItemMenu {

    public static final double WIDTH = 612.0;

    public static final double HEIGHT = 612.0 + 50.0;

    public static final String CONTENT =
            "M61.2,122.4h489.6c33.782,0,61.2-27.387,61.2-61.2S584.613,0,550.8,0H61.2C27.387,0,0,27.387,0,61.2"
