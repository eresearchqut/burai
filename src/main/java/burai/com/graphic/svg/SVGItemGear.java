...
public interface SVGItemGear {

    public static final double WIDTH = 932.179;

    public static final double HEIGHT = 932.179;

    public static final String CONTENT =
            "M61.2,341.538c4.9,16.8,11.7,33,20.3,48.2l-24.5,30.9c-8,10.1-7.1,24.5,1.9,33.6l42.2,42.2c9.1,9.1,23.5,9.899,33.6,1.899"
