...
public interface SVGItemTool {
    ...
    public static final double HEIGHT = 26.769;

    public static final String CONTENT =
            "M17.601,12.297c0.556-0.371,1.212-0.529,1.854-0.457l7.314-7.316l-4.096-4.096l-7.315,7.316"
                    + "c0.074,0.65-0.09,1.314-0.476,1.877L17.601,12.297z"
                    + "M4.842,21.207L4.577,20.942L3.19,22.063L0.854,25.744L1.452,26.342L5.136,24.006L6.256,22.623L5.99,22.354L"
                    + "10.642,17.701L9.486,16.561z"
                    + "M11.204,8.307c0.537-1.92,0.05-4.066-1.457-5.576C8.245,1.235,6.124,0.744,4.215,1.262l3.233,3.232L6.6,7.66L3.43,8.508"
