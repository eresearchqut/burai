...
public interface SVGItemArrowLeft {

    public static final double WIDTH = 493.578;

    public static final double HEIGHT = 493.578;

    public static final String CONTENT =
            "M487.267,225.981c0-17.365-13.999-31.518-31.518-31.518H194.501L305.35,83.615c12.24-12.24,12.24-32.207,0-44.676"
