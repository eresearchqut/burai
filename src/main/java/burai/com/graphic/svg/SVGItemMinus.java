...
public interface SVGItemMinus {

    public static final double WIDTH = 438.533;

    public static final double HEIGHT = 438.533;

    public static final String CONTENT =
            "M409.133,109.203c-19.608-33.592-46.205-60.189-79.798-79.796C295.736,9.801,259.058,0,219.273,0"
