...
public interface SVGItemMovieNext {

    public static final double WIDTH = 56.654;

    public static final double HEIGHT = 56.654;

    public static final String CONTENT =
            "M55.043,27.283L31.977,4.306c-0.946-0.942-2.27-1.479-3.66-1.479c-1.389,0-2.714,0.535-3.66,1.478L1.348,27.525"
                    ...
                    + "M56.654,48.161c0,3.129-2.537,5.666-5.668,5.666H5.667C2.537,53.827,0,51.29,0,48.161l0,0c0-3.131,2.537-5.668,5.667-5.668"
