...
public interface SVGItemTiles {

    public static final double WIDTH = 27.709;

    public static final double HEIGHT = 27.709;

    public static final String CONTENT =
            "M9.84,0.078h7.655V7.73H9.84V0.078z M9.84,9.918h7.655v7.652H9.84V9.918z M0,9.918h7.652v7.652H0"
