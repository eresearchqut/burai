...
public interface SVGItemCalculator {

    public static final double WIDTH = 60.731;

    public static final double HEIGHT = 60.731;

    public static final String CONTENT = "M28.909,0H7.421C3.324,0,0,3.323,0,7.42v21.488h28.908V0z M21.272,16.023h-5.008v5.032h-3.212v-5.032H8.047v-3.186h5.006"
